...
public class PlayerSim {
	...
	public static void main (String args[]) throws IOException {
		...
		*/
		...
		//0.5118214442884884,0.37797662041733127,0.2997545589414843,0.3785969665446932,0.8317452995234499,0.8243217479118918,0.8433610334458619,0.41646517455642984
		//0.43489298031045526,0.387098115522353,0.2550262979839542,0.30204674155375927,0.765572084377464,0.8277041032602208,0.8670023153053018,0.47022620327340003
		//0.47931095435315607,0.3656364777248954,0.27483189716019385,0.32895098269645523,0.7385630563198181,0.870256345363902,0.8685793393829021,0.433134721459981
		//allPlayers.add(new Player(0.52,0.44,0.41,0.0,0.82,0.78,0.9,0.0));
		//allPlayers.add(new Player(0.52,0.44,0.41,0.0,0.82,0.78,0.9,0.0));
		allPlayers.add(new Player(0.52,0.44,0.41,0.0,0.82,0.78,0.9,0.0));
		/*
		for (int i=0; i<10; i++) {
			allPlayers.add(new Player(0.43489298031045526,0.387098115522353,0.2550262979839542,0.30204674155375927,0.765572084377464,0.8277041032602208,0.8670023153053018,0.47022620327340003));
		}*/
		
		allPlayers.add(new Player(0.47931095435315607,0.3656364777248954,0.27483189716019385,0.32895098269645523,0.7385630563198181,0.870256345363902,0.8685793393829021,0.433134721459981));
		allPlayers.add(new Player(0.43489298031045526,0.387098115522353,0.2550262979839542,0.30204674155375927,0.765572084377464,0.8277041032602208,0.8670023153053018,0.47022620327340003));
		allPlayers.add(new Player(0.5118214442884884,0.37797662041733127,0.2997545589414843,0.3785969665446932,0.8317452995234499,0.8243217479118918,0.8433610334458619,0.41646517455642984));
		...
		allPlayers.add(new Player(0.5718216940219379,0.36855955660539585,0.3391981358372262,0.4189518322295907,0.818316738675473,0.8399573854933662,0.8663319173898942,0.37470363098334936));
